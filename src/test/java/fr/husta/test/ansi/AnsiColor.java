...
public abstract class AnsiColor
{
    ...
    private static String errColor = PREFIX + ATTR_DIM + SEPARATOR + FG_RED + SUFFIX;
    private static String warnColor = PREFIX + ATTR_DIM + SEPARATOR + FG_MAGENTA + SUFFIX;
    private static String infoColor = PREFIX + ATTR_DIM + SEPARATOR + FG_CYAN + SUFFIX;
    private static String verboseColor = PREFIX + ATTR_DIM + SEPARATOR + FG_GREEN + SUFFIX;
